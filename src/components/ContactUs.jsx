              ...
              <div className="space-y-6 mb-12">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@amar-ragda.com</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {branches.map((branch) => (
              <button
                ...
                className={`p-6 text-left rounded-lg transition-all ${selectedBranch.name === branch.name
                  ? 'bg-orange-600 text-white'
                  : 'bg-white hover:bg-orange-50'
                  }`}
              >
                <h3 className={`text-xl font-semibold mb-2 ${selectedBranch.name === branch.name ? 'text-white' : 'text-gray-900'
                  }`}>
                  {branch.name}
                </h3>
                <p className={`text-sm mb-2 ${selectedBranch.name === branch.name ? 'text-white' : 'text-gray-600'
                  }`}>
                  {branch.address}
                </p>
                <p className={`text-sm ${selectedBranch.name === branch.name ? 'text-white' : 'text-gray-600'
                  }`}>
                  {branch.hours}
                </p>
              </button>
